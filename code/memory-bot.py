...
prompt = PromptTemplate(
    ...
    template="""You are a helpful AI assistant.The following is a conversation between you and a human.
...
print("Hello!I am your new,smarter Q&A Bot with a memory.")
